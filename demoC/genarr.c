...
result[0]="src/redis-server() [0x42c319]\n";
result[1]=                                                   "/lib64/libc.so.6(__libc_start_main+0xf5) [0x7f664980c555]\n";
result[2]=                                                   "src/redis-server(main+0x40a) [0x42bf7a]\n";

result[3]=                                                  "src/redis-server(initServer+0x624) [0x433964]\n";

result[4]=                                                   "src/redis-server(scriptingInit+0x4df) [0x48654f]\n";

result[5]=                                                   "src/redis-server(createClient+0x80) [0x441970]\n";

result[6]=                                                   "src/redis-server(cyziServerLog+0xbe) [0x4c120e]\n";

result[7]=                                                   "src/redis-server(cyziServerLogRaw+0xf9) [0x4c1119]\n";
result[8]=                                                   "src/redis-server(printStacktrace+0x27) [0x4c0d27]\n";
